...
//   NB the scheduling is active FOR EVERY INSTANCE of the EJB!
//   that's why i'm using singleton scope
//   i also use @startup so that i'm sure the instance is created at application start time
    @Schedule(hour = "*")
